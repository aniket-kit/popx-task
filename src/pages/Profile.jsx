...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-start justify-center">
      <div className="border rounded-t-xl border-gray-200 w-full h-140 max-w-md mx-4 mt-8">

        <div className="bg-white rounded-t-xl shadow-none">

          <h2 className="text-lg font-semibold p-6 pb-3 text-left ">Account Settings</h2>
        </div>
        <div>
